...
}(window, window.angular), angular.module("biblioteca", [ "ngRoute" ]), angular.module("biblioteca").config(function($routeProvider) {
    $routeProvider.when("/", {
...
}), angular.module("biblioteca").controller("loginCtrl", function($scope) {});